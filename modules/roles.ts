...
const VipRole = new Role().setPrefix("💎").setPosition(4).setColor(0x69e7f5).setName("vip");
VipRole.settings.delay = 0;
const ModeradorRole = new Role().setPrefix("👮").setPosition(5).setAdmin().setColor(0x57cfff).setName("moderador");
ModeradorRole.settings.delay = 0;
const DiretorRole = new Role().setPrefix("👑").setPosition(6).setAdmin().setColor(0xf03c4e).setName("diretor");
